    ...
    public class Votacion
    {
        ...
        public List<KeyValuePair<string, EVoto>> Senadores
        {
            get
            {
                ...
                foreach(KeyValuePair<string, EVoto> aux in this.senadores)
                {
                    lista.Add(aux);
                }
                return lista;
        ...
        public event Voto EventoVotoEfecutado;
        ...
        public void Simular()
        {
            ...
            for (int index = 0; index < this.senadores.Count; index++)
            {
               ...
               // System.Threading.Thread.Sleep(2134);
                ...
                // Invocar Evento
                this.EventoVotoEfecutado.Invoke(k.Key, this.senadores[k.Key]);
                // Incrementar contadores
                if(this.senadores[k.Key] == EVoto.Afirmativo)
                {
                    this.contadorAfirmativo++;
                }
                if(this.senadores[k.Key] == EVoto.Negativo)
                {
